...
This module supports the comparison between small-step and big-step semantics,
and helps validate semantic equivalence across different specification styles.
-}
